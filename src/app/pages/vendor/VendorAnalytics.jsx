  ...
  return (
    <DashboardLayout menuItems={menuItems} userRole="vendor">
      <div className="min-h-screen bg-gradient-to-br from-white to-purple-50 text-slate-900 font-sans relative overflow-hidden dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-slate-900 dark:text-slate-100">
        ...
        <div className="max-w-7xl mx-auto relative z-10 space-y-6 sm:space-y-8 p-3 sm:p-6 lg:p-8">
          
          {/* Hero / Header Section (match site style) */}
          <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-r from-purple-800 via-pink-700 to-blue-700 p-5 sm:p-8 lg:p-10 text-white shadow-2xl hover:shadow-3xl transition-shadow duration-500 dark:from-[#040b1b] dark:via-[#091628] dark:to-[#061a2d]">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex-1">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-black leading-tight fade-in-up">Vendor Analytics</h2>
              ...
              <div className="flex-none w-32 h-32 md:w-44 md:h-44 lg:w-48 lg:h-48 rounded-xl flex items-center justify-center hidden sm:flex">
          ...
          <div className="relative bg-white border border-purple-200/80 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow dark:bg-slate-900 dark:border-purple-400/35">
            ...
            <div className="relative z-10 p-6">
              ...
              {/* Stats */}
              <div className="grid grid-cols-2 lg:grid-cols-4 mt-6 pt-4 border-t border-slate-200 gap-4 sm:gap-6 dark:border-slate-700">
                <div>
                  <p className="text-xs font-bold text-slate-600 uppercase tracking-wide dark:text-slate-300">Proposals Sent</p>
                  <p className="text-xl sm:text-2xl lg:text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600 mt-2">
                ...
                <div>
                  ...
                  <div className="flex items-baseline gap-2 mt-2">
                    <p className="text-xl sm:text-2xl lg:text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-indigo-700">
                ...
                <div>
                  ...
                  <p className="text-lg sm:text-xl lg:text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-rose-600 mt-2">
                ...
                <div>
                  ...
                  <p className="text-xl sm:text-2xl lg:text-3xl font-black text-emerald-600 mt-2">
