        ...
        <DashboardLayout menuItems={menuItems} userRole="admin">
            ...
            >
                <DialogContent className="border border-indigo-100" aria-describedby={undefined}>
                    ...
                    <p className="text-sm text-slate-600">Update the category details then save to apply changes.</p>
            ...
            >
                <DialogContent className="border border-indigo-100" aria-describedby={undefined}>
                    ...
                    <p className="text-sm text-slate-600">Review category details including request and vendor activity.</p>

                    {viewingCategory && (
                        <div className="space-y-3 py-2">
                            <div className="rounded-lg border border-slate-200 bg-slate-50/80 p-3">
                                <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Category Name</p>
                                <p className="mt-1 font-semibold text-slate-900">{viewingCategory.name}</p>
                            </div>
                            <div className="rounded-lg border border-slate-200 bg-white p-3">
                                <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Description</p>
                                <p className="mt-1 text-sm text-slate-700">{viewingCategory.description || 'No description provided yet.'}</p>
                            </div>
                            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                <div className="rounded-lg border border-indigo-100 bg-indigo-50/70 p-3">
                                    ...
                                    <p className="mt-1 font-semibold text-slate-900">{viewingCategory.requestCount}</p>
                                </div>
                                <div className="rounded-lg border border-cyan-100 bg-cyan-50/70 p-3">
                                    ...
                                    <p className="mt-1 font-semibold text-slate-900">{viewingCategory.vendorCount}</p>
                                </div>
                            </div>
                        </div>
                    )}
                        ...
                        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                            ...
                            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
                                ...
                                <DialogContent className="border border-indigo-100" aria-describedby={undefined}>
                                    ...
                                    <p className="text-sm text-slate-600">Create a category with name and description to organize requests.</p>
                                    <div className="space-y-4 py-4">
                                        <div className="space-y-2">
                                            <Label>Category Name</Label>
                                            <Input
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {paginatedCategories.map((category, index) => {
                        ...
                        return (
                            <Card
                                key={category.id}
                                className="group relative overflow-hidden border-0 bg-white shadow-[0_10px_28px_rgba(30,41,59,0.08)] ring-1 ring-indigo-100/70 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_18px_42px_rgba(99,102,241,0.18)] hover:ring-indigo-200"
                            >
                                <CardContent className="relative p-6">
                                    ...
                                    <p className="relative mb-4 text-sm text-slate-600 line-clamp-2">{category.description || 'No description provided yet.'}</p>
                                    ...
                                    <div className="relative flex gap-2 rounded-xl border border-slate-200/80 bg-slate-50/80 p-2">
                                        <Button
                                            size="sm"
                                            variant="outline"
                                            className="h-9 flex-1 gap-2 border-indigo-200 text-indigo-700 hover:bg-indigo-50"
                                        ...
                                        <Button
                                            size="sm"
                                            variant="outline"
                                            className="h-9 flex-1 gap-2 border-slate-300 text-slate-700 hover:border-[#6f74ea] hover:text-[#6f74ea]"
