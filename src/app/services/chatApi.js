...
function normalizeChatRoom(raw) {
  ...
  return {
    ...
    clientProfilePictureUrl: pick(raw, 'clientProfilePictureUrl', 'ClientProfilePictureUrl') ?? null,
    vendorId: String(pick(raw, 'vendorId', 'VendorId') ?? ''),
    vendorName: String(pick(raw, 'vendorName', 'VendorName') ?? 'Vendor'),
    vendorProfilePictureUrl: pick(raw, 'vendorProfilePictureUrl', 'VendorProfilePictureUrl') ?? null,
